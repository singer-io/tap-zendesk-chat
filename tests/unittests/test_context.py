...
class TestContextFunctions(unittest.TestCase):
    ...
    def test_bookmarks(self):
        """
        tests bookmarks property for context module
        returns {} with bookmarks key in state file
        """
    ...
    def test_get_bookmark(self):
        ...
        """
        self.context_client.state = {"bookmarks": {"account": {"last_created": "2022-06-01"},
                                                   "chats": {"chat.end_timestamp": "2022-06-01T15:00:00",
                                                             "offline_msg.timestamp": "2022-06-01T18:00:00"}}}
    ...
    def test_set_bookmark(self):
        """
        tests set_bookmark fn in context.py
        set the bookmark using set_bookmark fn and assert the bookmark for stream in state json
        """
        self.context_client.state = {"bookmarks": {"account": {"last_created": "2022-06-01"},
                                                   "chats": {"chat.end_timestamp": "2022-06-01T15:00:00",
                                                             "offline_msg.timestamp": "2022-06-01T18:00:00"}}}
